            ...
            renderItem={item => (item &&
                <List.Item
                    ...
                    actions={[
                        ...
                        <IconText icon={MessageOutlined} text={item.commentCount || 0} key="list-vertical-message" />,
                    ]}
                    extra={
                        <Link to={{ pathname: '/detail', query: item }} target="_blank" >
                            <img
                                ...
                                onClick={() => { linkToDetail(item.blogId) }}
                            />
                        </Link>
                ...
                >
                    <List.Item.Meta
                        ...
                        title={
                            <Link to={{ pathname: '/detail', query: item }} target="_blank">
                                <a onClick={() => { linkToDetail(item.blogId) }}>{item.title}</a>
                            </Link>
                        }
